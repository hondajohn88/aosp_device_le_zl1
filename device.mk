...
PRODUCT_COPY_FILES += \
    device/leeco/le_zl1/mixer_paths.xml:system/etc/mixer_paths.xml \
    device/leeco/le_zl1/audio_platform_info.xml:system/etc/audio_platform_info.xml \
    device/leeco/le_zl1/audio_platform_info_extcodec.xml:system/etc/audio_platform_info_extcodec.xml \
    device/leeco/le_zl1/sound_trigger_mixer_paths.xml:system/etc/sound_trigger_mixer_paths.xml \
    device/leeco/le_zl1/sound_trigger_mixer_paths_wcd9306.xml:system/etc/sound_trigger_mixer_paths_wcd9306.xml \
    device/leeco/le_zl1/sound_trigger_mixer_paths_wcd9330.xml:system/etc/sound_trigger_mixer_paths_wcd9330.xml \
    device/leeco/le_zl1/sound_trigger_mixer_paths_wcd9335.xml:system/etc/sound_trigger_mixer_paths_wcd9335.xml \
    device/leeco/le_zl1/sound_trigger_platform_info.xml:system/etc/sound_trigger_platform_info.xml
